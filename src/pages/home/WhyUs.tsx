...
const WhyUs = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center h-auto md:h-[90vh] gap-5">
      <motion.h1 className="text-[40px] font-bold">Why Choose PrepBank?</motion.h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mt-10 w-[90%]">
        <motion.div
          ...
          className="card flex flex-col items-center cursor-pointer p-4 bg-gray-800 rounded-lg shadow-lg border-2 border-transparent hover:border-csgreen"
        >
